    ...
    <div className="bg-dojo-black">
      ...
      <section className="py-16">
        <div className="mx-auto max-w-5xl px-6">
            ...
            {schedule.map((day) => (
              ...
              >
                ...
                {day.classes.length === 0 ? (
                  <p className="text-dojo-ink/85 text-sm italic">No classes scheduled</p>
                ) : (
                    ...
                    {day.classes.map((cls) => (
                      ...
                      >
                        <div className="flex items-center justify-between gap-2 mb-1">
                          ...
                          <span className="text-xs opacity-90">{cls.duration}</span>
                        </div>
          ...
          {/* Note */}
          <p className="text-dojo-ink/90 text-sm text-center mt-8">
      ...
      <section className="py-20 bg-dojo-gray border-t border-white/5">
        <div className="mx-auto max-w-5xl px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-dojo-ink/95 max-w-2xl mx-auto leading-relaxed">
            ...
            <p className="text-dojo-ink/95 max-w-2xl mx-auto leading-relaxed mt-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-dojo-black rounded-2xl border border-white/5 p-8">
              ...
              <p className="text-dojo-ink/95 text-sm leading-relaxed mb-5">
              ...
              <p className="text-dojo-ink/90 text-xs font-semibold tracking-widest uppercase mb-3">
              ...
              <p className="text-dojo-ink/95 text-sm leading-relaxed">
      ...
      <section className="py-16 border-t border-white/5">
        <div className="mx-auto max-w-xl px-6 text-center">
          ...
          <p className="text-dojo-ink/95 mb-8">Your first class is free. No commitment required.</p>
          <Link
            href="/contact"
