          ...
          <div>
            ...
            {state === "success" ? (
              <div className="bg-green-900/30 border border-green-500/30 rounded-xl p-8 text-center">
                ...
                <p className="text-dojo-ink text-sm leading-relaxed">
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-5">
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label className="block text-xs font-semibold tracking-widest uppercase text-dojo-ink/95 mb-2">
                      First Name *
                    </label>
                    <input
                      type="text"
            ...
            {[
              ...
              <div key={item.title} className="bg-dojo-gray rounded-xl p-6 border border-white/5 flex gap-4">
                ...
                <div>
                  ...
                  {item.href ? (
                    <a href={item.href} className="text-dojo-ink hover:text-dojo-ink transition-colors text-sm">
                      {item.content}
                    </a>
                  ) : (
                    <p className="text-dojo-ink text-sm">{item.content}</p>
                  )}
                </div>
              </div>
            ))}
              ...
              <ul className="flex flex-col gap-2 text-sm">
                {[
                  ...
                  <li key={row.day} className="flex justify-between">
                    <span className="text-dojo-ink/95 font-semibold">{row.day}</span>
                    <span className={row.time === "Closed" ? "text-dojo-ink/85" : "text-dojo-ink"}>
                      {row.time}
                    </span>
                  </li>
                ))}
