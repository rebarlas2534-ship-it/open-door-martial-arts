    ...
    <div className="bg-dojo-black">
      ...
      <section className="py-20 bg-dojo-gray border-b border-white/5">
        <div className="mx-auto max-w-5xl px-6 text-center">
          ...
          <p className="text-dojo-ink/95 max-w-md mx-auto leading-relaxed">
              ...
              >
                <div>
                  ...
                  <div className="flex items-baseline gap-1 mt-4">
                    ...
                    <span className="text-dojo-ink/90 text-sm">{plan.period}</span>
                  </div>
                </div>

                <ul className="flex flex-col gap-3 flex-1">
                  {plan.includes.map((item) => (
                    <li key={item} className="flex items-start gap-3 text-dojo-ink text-sm leading-relaxed">
        ...
        <div className="mx-auto max-w-3xl px-6">
          <div className="rounded-2xl border border-white/5 bg-dojo-gray p-8 flex flex-col sm:flex-row sm:items-center gap-6 justify-between">
            <div>
              ...
              <p className="text-dojo-ink text-sm leading-relaxed max-w-md">
            ...
            <div className="flex items-baseline gap-1 sm:flex-shrink-0">
              ...
              <span className="text-dojo-ink/90 text-sm">/ class</span>
            </div>
          </div>
        </div>
      </section>
              ...
              {additionalFees.map((fee) => (
                <li key={fee.label} className="flex items-center justify-between py-4 gap-4">
                  <div>
                    ...
                    <p className="text-dojo-ink/90 text-xs mt-0.5">{fee.note}</p>
                  </div>
      ...
      <section className="py-16">
        <div className="mx-auto max-w-xl px-6 text-center">
          <p className="text-dojo-ink/95 leading-relaxed mb-8 text-lg">
